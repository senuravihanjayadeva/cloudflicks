...
import "../plugins/custom-timestamp-plugin.js";
...
import "../plugins/custom-speed-control-plugin.js";
...
export const VideoPlayer = (props) => {
  ...
  useEffect(() => {
    ...
    if (!playerRef.current) {
      console.log("player current ref dont  have");
      ...
      //Use Custom Speed Control Plugin
      options.settings && player.customSpeedControl();

      //Use Custom Setting Plugin
      options.settings &&
      ...
      player.customLanguageSupport();
      if (lang) {
        options.settings && player.customSettings(languageTranslate[lang]);
      }
